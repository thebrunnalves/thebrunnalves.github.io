...
$(function() {
   /* fullMenu(), menuMobile(), headerFixed(), searchFixed(), cartWithPrice(), app(),*/contatoRodape(), bemVindo(), abrigaLogo(), abrigaPainel(), abrigaContato(), abrigaConta(), abrigaCarrinho(), abrigaMenu(), infoBanner(), benefitsMobile(), /*tracking(),*/ discountOff(), addWishlist(), responsiveShowcase(), shareThis(), tabsDescription(), /*measurementTable(), whatsAppFixed(),*/ video(), instagram(), /*freeShippingNotice(),*/ busca(), goTop()
});
