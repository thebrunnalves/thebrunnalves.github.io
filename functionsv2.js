...
$(function() {
   /* fullMenu(), menuMobile(), headerFixed(), searchFixed(), cartWithPrice(),app(),*/svg(), contatoRodape(), abrigaLogo(), abrigaConta(), abrigaPainel(), abrigaContato(), bemVindo(),/*abrigaMenu(), removeConteudoTopo(),*/ dropDown(), infoBanner(), benefitsMobile(), /*tracking(),*/ discountOff(), addWishlist(), responsiveShowcase(), shareThis(), tabsDescription(), measurementTable(), /*whatsAppFixed(),*/ video(), instagram(), /*freeShippingNotice(),*/ busca(), goTop()
});
