...
$(function() {
   /* fullMenu(), menuMobile(), headerFixed(), searchFixed(), cartWithPrice(), app(),*/ bemVindo(), abrigaLogo(), abrigaPainel(), abrigaConta(), abrigaCarrinho(), abrigaMenu(), infoBanner(), benefitsMobile(), /*tracking(),*/ discountOff(), addWishlist(), responsiveShowcase(), shareThis(), tabsDescription(), /*measurementTable(), whatsAppFixed(),*/ video(), instagram(), /*freeShippingNotice(),*/ busca(), goTop()
});
