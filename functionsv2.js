...
$(function() {
   /* fullMenu(), menuMobile(), headerFixed(), searchFixed(), cartWithPrice(), app(),*/ abrigaLogo(), abrigaPainel(), abrigaConta(), abrigaCarrinho(), infoBanner(), benefitsMobile(), /*tracking(),*/ discountOff(), addWishlist(), responsiveShowcase(), shareThis(), tabsDescription(), /*measurementTable(), whatsAppFixed(),*/ video(), instagram(), /*freeShippingNotice(),*/ busca(), goTop()
});
