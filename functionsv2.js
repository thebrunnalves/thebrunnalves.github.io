...
$(function() {
    fullMenu(), menuMobile(), headerFixed(), searchFixed(), cartWithPrice(), app(), infoBanner(), benefitsMobile(), tracking(), discountOff(), addWishlist(), responsiveShowcase(), shareThis(), tabsDescription(), measurementTable(), whatsAppFixed(), video(), instagram(), freeShippingNotice(), goTop()
});