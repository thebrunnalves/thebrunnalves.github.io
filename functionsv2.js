...
var accountMenu = function() {
    ...
    instagram = function() {
        if ("undefined" != typeof configInstagram) {
            var i = configInstagram.user,
                e = "<div id='instagram' class='line'><h2><span><svg class='icon' xmlns='http://www.w3.org/2000/svg' viewBox='-8700.68 2378.321 32.422 32.421'><path id='Union_72' data-name='Union 72' class='cls-1' d='M7835.447-3201.945a8.957,8.957,0,0,1-8.947-8.947v-14.528a8.957,8.957,0,0,1,8.947-8.946h14.526a8.957,8.957,0,0,1,8.949,8.946v14.528a8.957,8.957,0,0,1-8.949,8.947Zm-6.071-23.475v14.528a6.077,6.077,0,0,0,6.071,6.069h14.528a6.075,6.075,0,0,0,6.069-6.069v-14.528a6.079,6.079,0,0,0-6.071-6.071h-14.526A6.078,6.078,0,0,0,7829.376-3225.42Zm4.98,7.264a8.364,8.364,0,0,1,8.355-8.355,8.363,8.363,0,0,1,8.353,8.355,8.361,8.361,0,0,1-8.353,8.353A8.362,8.362,0,0,1,7834.356-3218.156Zm2.877,0a5.483,5.483,0,0,0,5.478,5.477,5.484,5.484,0,0,0,5.477-5.477,5.484,5.484,0,0,0-5.477-5.477A5.483,5.483,0,0,0,7837.233-3218.156Zm12.692-7.191a2.128,2.128,0,0,1-.622-1.493,2.114,2.114,0,0,1,.622-1.491,2.116,2.116,0,0,1,1.489-.617,2.127,2.127,0,0,1,1.493.617,2.118,2.118,0,0,1,.617,1.491,2.132,2.132,0,0,1-.617,1.493,2.138,2.138,0,0,1-1.493.617A2.123,2.123,0,0,1,7849.926-3225.347Z' transform='translate(-16527.18 5612.687)'/></svg>" + configInstagram.title + "</span><a href='https://instagram.com/" + i + "' target='blank'>@" + i + "</a></h2><ul></ul></div>";
    ...
    shareThis = function() {
        $("body.pagina-produto .cep #formCalcularCep").after($("<div class='sharethis-inline-share-buttons'></div>")), $(".sharethis-inline-share-buttons").append($("<script>", {
    ...
    tracking = function() {
        $(".barra-inicial .canais-contato").append("<div class='rastreio'></div>"), $(".rastreio").append($("<a class='trigger-rastreio'><svg class='icon' xmlns='http://www.w3.org/2000/svg' viewBox='5219.872 13.743 10.5 14'><path class='a' d='M65.9,0a5.25,5.25,0,0,0-4.2,8.4L65.9,14l4.2-5.6A5.25,5.25,0,0,0,65.9,0Zm0,8.75a3.5,3.5,0,1,1,3.5-3.5A3.5,3.5,0,0,1,65.9,8.75Z' transform='translate(5159.221 13.743)'/></svg><span>Rastreie seu pedido</span></a><form class='form-rastreio'><span>Digite o código de rastreio para acompanhar seu pedido:</span><div class='wrap'><input type='text' placeholder='Código'><button class='rastrear'></button></div></form>")), $(".rastrear").click(function(i) {
            i.preventDefault();
            var e = "https://rastreamentocorreios.info/consulta/" + $(".form-rastreio input").val();
            window.open(e, "blank")
        })
    },
    widthMenu = function() {
...
$(function() {
    tabsDescription(),benefitsMobile(), whatsAppFixed(), fullMenu(), /*otherCategories(), /*widthMenu(),*/ accountMenu(), headerFixed(), floatMenu(), menuMobile(), searchFixed(),/* tracking(),*/ cartWithPrice(), responsiveShowcase(), discountOff(), addWishlist(), shareThis(), instagram(), toTop(), copyright(), app()
});